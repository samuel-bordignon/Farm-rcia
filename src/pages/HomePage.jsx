        ...
        <div>
            ...
            <div className='homepage-container'>
                <div className = "section">
                    <div>
                        <img src="./images/Gut health-pana.png" alt="" />
                    </div>
                    <div>
                        <h2>Bem-vindo à nova Farmárcia!</h2>
                        <p>
                            A Far<span class="highlight">márcia</span> está de cara nova e, convenhamos, estava na hora!
                            Depois de anos com um layout quadrado e ultrapassado, finalmente nos livramos das ideias jurássicas do antigo dono, o Márcio.
                ...
                <div className = "section" id='section-grid'>
                    <div><h2>Do Márcio ao Márcia – uma revolução visual</h2>
                        <p>
                            Antes, a página da Farmárcia parecia mais uma lista de compras do Márcio do que uma farmácia online.
                            Nós acreditamos que merecemos mais! Transformamos o caos do antigo design em algo digno de ser visitado.
                            Com cores vibrantes e uma interface amigável, agora navegar por aqui será uma experiência sem dor de cabeça – desculpa, Márcio!
                        </p></div>
                    <div><h2>A última ideia do Márcio? O botão de "clique aqui" gigante</h2>
                        <p>
                            Vamos ser sinceros: o antigo dono, o Márcio, tinha boas intenções, mas suas escolhas de design deixavam a desejar.
                    ...
                    <div><h2>Adeus ao "estilo Márcio", olá ao futuro!</h2>
                        <p>
                            Antes, a Farmárcia parecia parada no tempo, assim como o gosto do Márcio por layouts cheios de tabelas e pop-ups irritantes.
                ...
                <div className = "section">
                    <h2>Um site tão eficiente quanto a Márcia, sem as "melhorias" do Márcio</h2>
                    <p>
                        Agora que o Márcio não está mais no controle, você pode respirar aliviado.
